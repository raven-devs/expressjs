...
(function (N, q) {
    ...
    function q(a) {
        for (
            var b = arguments.length - 1, d = 'https://reactjs.org/docs/error-decoder.html?invariant=' + a, g = 0;
            g < b;
            g++
        )
    ...
    function Q() {
        ...
        if ('function' === typeof n)
            if (((n = { callback: n, priorityLevel: a, expirationTime: b, next: null, previous: null }), null === c))
    ...
    function ya(a, b, d) {
        ...
        Array.isArray(a)
            ...
            : null != a &&
              (S(a) &&
                  (a = ua(a, c + (!a.key || (b && b.key === a.key) ? '' : ('' + a.key).replace(la, '$&/') + '/') + d)),
              g.push(a));
    }
